...
class RationalFunctionOverField[R <: PolynomialOverUFD.Element[R, C, N], C, N](override implicit val ring: PolynomialOverField[R, C, N]) extends RationalFunction[R, C, N] {

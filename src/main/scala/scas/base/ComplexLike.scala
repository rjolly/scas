...
import scas.polynomial.residue.AlgebraicNumberLike
...
trait ComplexLike extends AlgebraicNumberLike[UnivariatePolynomial.Element[Rational, Int], Rational, Int] {

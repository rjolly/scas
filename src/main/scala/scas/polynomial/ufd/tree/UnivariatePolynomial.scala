...
class UnivariatePolynomial[C, @specialized(Int, Long) N](val ring: Field[C], val pp: PowerProduct[N])(implicit val cm: ClassManifest[Element[C, N]]) extends TreePolynomial[Element[C, N], C, N] with scas.polynomial.ufd.UnivariatePolynomial[Element[C, N], C, N] {
...
object UnivariatePolynomial {
  ...
  class Element[C, @specialized(Int, Long) N](val value: SortedMap[Array[N], C], val syzygy: Module.Element[Polynomial.Element[C, N]])(val factory: UnivariatePolynomial[C, N]) extends TreePolynomial.Element[Element[C, N], C, N] with scas.polynomial.ufd.UnivariatePolynomial.Element[Element[C, N], C, N]

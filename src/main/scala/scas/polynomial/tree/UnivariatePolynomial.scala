...
class UnivariatePolynomial[C, N](val ring: Field[C], val pp: PowerProduct[N], val module: Module[Polynomial.Element[C, N], C, N])(implicit val cm: ClassTag[Element[C, N]]) extends TreePolynomial[Element[C, N], C, N] with scas.polynomial.UnivariatePolynomialWithRepr[Polynomial.Element, Element[C, N], C, N] {
...
object UnivariatePolynomial {
  ...
  class Element[C, N](val value: SortedMap[Array[N], C], val element: Module.Element[Polynomial.Element[C, N]])(val factory: UnivariatePolynomial[C, N]) extends TreePolynomial.Element[Element[C, N], C, N] with scas.polynomial.UnivariatePolynomialWithRepr.Element[Polynomial.Element, Element[C, N], C, N]

...
object PolynomialWithGB {
  ...
  class Element[C, N](val value: (Array[C], Array[N]))(val factory: PolynomialWithGB[C, N]) extends ArrayPolynomial.Element[Element[C, N], C, N] with scas.polynomial.PolynomialOverUFD.Element[Element[C, N], C, N]

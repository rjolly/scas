...
object PolynomialWithSugar {
  ...
  class Element[C, N](val value: (Array[C], Array[N]), val sugar: Long)(val factory: PolynomialWithSugar[C, N]) extends ArrayPolynomial.Element[Element[C, N], C, N] with scas.polynomial.ufd.gb.PolynomialWithSugar.Element[Element[C, N], C, N]

...
trait PolynomialWithSugar[C, N] extends ArrayPolynomial[Element[C, N], C, N] with scas.polynomial.PolynomialWithSugar[Element[C, N], C, N] {
  ...
  def apply(value: (Array[C], Array[N], Array[N]), sugar: Long) = new Element(value, sugar)(this)
  def apply(value: (Array[C], Array[N], Array[N])) = apply(value, 0l)
}
...
object PolynomialWithSugar {
  ...
  class Element[C, N](val value: (Array[C], Array[N], Array[N]), val sugar: Long)(val factory: PolynomialWithSugar[C, N]) extends ArrayPolynomial.Element[Element[C, N], C, N] with scas.polynomial.PolynomialWithSugar.Element[Element[C, N], C, N]

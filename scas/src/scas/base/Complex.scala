...
object Complex extends Complex.Impl(using UnivariatePolynomial(Rational)(Variable.sqrt(BigInteger("-1")))) with scas.residue.conversion.Residue[Complex, Rational, Array[Int]] {

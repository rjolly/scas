...
object Complex extends Complex.Impl(using new UnivariatePolynomial(using Rational, Lexicographic[Int](Variable.sqrt(BigInteger("-1"))))) with scas.residue.conversion.AlgebraicNumber[Rational, Array[Int]] with scas.structure.commutative.StarUFD[Complex] {

...
class MultivariatePolynomialOverField[C](using Field[C])(val s: Variable*) extends MultivariatePolynomial[C] with scas.polynomial.ufd.MultivariatePolynomialOverField[Element, C, Array[Int]] {

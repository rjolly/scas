...
class MultivariatePolynomialOverField[C, S : Conversion[Variable]](using Field[C])(s: S*) extends MultivariatePolynomial[C, S](s*) with scas.polynomial.ufd.MultivariatePolynomialOverField[Element, C, Array[Int]] {

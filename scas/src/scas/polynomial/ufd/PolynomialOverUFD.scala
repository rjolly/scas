...
trait PolynomialOverUFD[T : ClassTag, C : UniqueFactorizationDomain.Impl, M : PowerProduct.Impl] extends PolynomialOverUFD.Impl[T, C, M] with Polynomial[T, C, M] with UniqueFactorizationDomain[T]

object PolynomialOverUFD {
  trait Impl[T : ClassTag, C, M : PowerProduct.Impl](using ring: UniqueFactorizationDomain.Impl[C]) extends Polynomial.Impl[T, C, M] with UniqueFactorizationDomain.Impl[T] {
    def gcd1(x: T, y: T): T

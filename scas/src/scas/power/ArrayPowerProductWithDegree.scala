...
trait ArrayPowerProductWithDegree[N : Numeric : ClassTag : ClassTagArray] extends ArrayPowerProductWithDegree.Impl[N] with ArrayPowerProduct[N]

object ArrayPowerProductWithDegree {
  trait Impl[N : ClassTag : ClassTagArray](using numeric: Numeric[N]) extends ArrayPowerProduct.Impl[N] {

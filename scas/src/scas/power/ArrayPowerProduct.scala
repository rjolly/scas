...
trait ArrayPowerProduct[N : Numeric : ClassTagArray] extends ArrayPowerProduct.Impl[N] with PowerProduct[Array[N]]

object ArrayPowerProduct {
  trait Impl[N](using numeric: Numeric[N]) extends PowerProduct.Impl[Array[N]] {
